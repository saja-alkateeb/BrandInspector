...
4️⃣ Configure the WinForms App
...
🧾 Example API Flow
1️⃣ POST /auth/login → JWT token  
2️⃣ GET /brand/fonts → ["Arial", "Times New Roman"]  
3️⃣ GET /brand/colors → ["#000000", "#FFFFFF"]  
4️⃣ GET /brand/sizes → [14, 32]
